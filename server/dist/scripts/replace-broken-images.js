...
const PLACEHOLDER_IMAGE = 'https://res.cloudinary.com/dqbre9j3o/image/upload/v1765026400/ecommerce/h0s3zygdovjif8dkepty.jpg';
...
async function run() {
    const client = new MongoClient('mongodb+srv://fishhuntgeo:w4fc9PXQLDYwNUUe@ecommerce.ddxri.mongodb.net/?retryWrites=true&w=majority');
    try {
            ...
            for (const doc of docs){
                ...
                for (const brokenId of BROKEN_IMAGE_IDS){
                    if (str.includes(brokenId)) {
                        ...
                        const regex = new RegExp(`https://res\\.cloudinary\\.com/[^/]+/image/upload/[^"]*${brokenId}[^"]*`, 'g');
...
//# sourceMappingURL=replace-broken-images.js.map
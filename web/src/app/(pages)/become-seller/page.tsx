    ...
    <div className="become-seller-container">
      ...
      <div className="become-seller-content">
        ...
        <div className="hero-section">
          <p className="hero-text">{t("becomeSeller.heroText")}</p>
        </div>

        <div className="seller-section">
          <h2 className="section-title">
            {t("becomeSeller.whyFishHuntTitle")}
          </h2>
        ...
        <div className="seller-section">
          <h2 className="section-title">
            {t("becomeSeller.sellerPanelTitle")}
          </h2>
        ...
        <div className="seller-section pricing-section">
          ...
          <p className="pricing-note">{t("becomeSeller.pricingNote")}</p>
        </div>
        ...
        <div className="cta-final-section">
          ...
          <p className="cta-final-text">{t("becomeSeller.ctaFinalText")}</p>
          ...
          <p className="cta-note">{t("becomeSeller.ctaNote")}</p>
        </div>
      </div>
    </div>
  );
